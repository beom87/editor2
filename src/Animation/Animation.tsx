...
import Sprite from '../editor/animations/sprite';
...
export default function Animation() {
    ...
    return (
        <>
            <div>
                <button className='border rounded' onClick={onCreateAnimationClick}>Create Animation</button>
                {animationState === 'fullfilled' && <button className='border rounded' onClick={onPlayClick}>Play</button>}
                {animationState === 'running' && <button className='border rounded' onClick={onStopClick}>Stop</button>}
            </div>
            <div>
